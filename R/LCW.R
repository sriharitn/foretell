...
#'
#' @examples
#' surv_value <- c(1,0.869,0.743,0.653,0.593,0.551,0.517,0.491,0.468,0.445,0.427,0.409,0.394)
#' h <- 6
#' LCW(surv_value,h)
#'
...
LCW <- function(surv_value,h, lower = c(0.001,0.001,0.001,0.001,0.001),upper = c(0.99999,10000,0.999999,10000,0.99999)){
  ...
  list(fitted = c(1,cw[1:t]),projected = cw[(t+1):(t+h)],max.likelihood = max.lik.cw$value, params = c(t1=t1,c1=c1,t2=t2,c2=c2,w=w))
